...
async function validateAndRepairWithDeepSeek(courses) {
  const prompt = `你是课程表结构校验器。请检查下面 JSON 中的课程：\n${JSON.stringify(courses, null, 2)}\n\n请修复明显的格式错误、时间顺序错误、星期格式错误、重复课程，并保留图片识别到的原始课程名称。不要凭空增加课程。只输出 JSON：{"courses":[{"title":"","day":"周一","start":"08:00","end":"08:50","room":"","type":"课程","task":"","color":"#dbeafe","confidence":1}],"issues":["问题说明"]}`;
  const settings = loadAISettings();
  let apiJson;
